...
parser.add_argument('--rank',     default = 8,              help="Rank of hyperspectral images")
...
if data_name == 'Case0_15':
    args.LR_iter, args.R_iter, args.lambda_R = 900,  700,  0.02
elif data_name == 'Case0_35':
    args.LR_iter, args.R_iter, args.lambda_R = 700,  700,  0.06
elif data_name == 'Case0_55':
    args.LR_iter, args.R_iter, args.lambda_R = 1000, 600,  0.06
else:
    args.LR_iter, args.R_iter, args.lambda_R = 1200, 1000, 0.03
