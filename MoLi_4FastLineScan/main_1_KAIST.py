...
parser.add_argument('--lambda_',  default = 0.04,           help="Facotr of the deep Low-rank regularization")
...
parser.add_argument('--rank',     default = 4,              help="Rank of hyperspectral images")
...
if data_name == 'Case0_15':
    ...
    args.LR_iter, args.R_iter, args.lambda_R = 700,  300, 0.03
